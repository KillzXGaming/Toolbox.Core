...
namespace Toolbox.Core
{
    public class Decode_Gamecube
    {
        ...
        public static TexFormat ToGenericFormat(TextureFormats Format)
        {
            switch (Format)
            {
                case TextureFormats.C14X2: return TexFormat.C14X2;
                case TextureFormats.C4: return TexFormat.C4;
                case TextureFormats.C8: return TexFormat.C8;
                case TextureFormats.CMPR: return TexFormat.CMPR;
                case TextureFormats.I4: return TexFormat.I4;
                case TextureFormats.I8: return TexFormat.I8;
                case TextureFormats.IA4: return TexFormat.IA4;
                case TextureFormats.IA8: return TexFormat.IA8;
                case TextureFormats.RGB565: return TexFormat.RGB565;
                case TextureFormats.RGB5A3: return TexFormat.RGB5A3;
                case TextureFormats.RGBA32: return TexFormat.RGBA32;
                default:
        ...
        public static TextureFormats FromGenericFormat(TexFormat Format)
        {
            switch (Format)
            {
                case TexFormat.C14X2: return TextureFormats.C14X2;
                case TexFormat.C4: return TextureFormats.C4;
                case TexFormat.C8: return TextureFormats.C8;
                case TexFormat.CMPR: return TextureFormats.CMPR;
                case TexFormat.I4: return TextureFormats.I4;
                case TexFormat.I8: return TextureFormats.I8;
                case TexFormat.IA4: return TextureFormats.IA4;
                case TexFormat.IA8: return TextureFormats.IA8;
                case TexFormat.RGB565: return TextureFormats.RGB565;
                case TexFormat.RGB5A3: return TextureFormats.RGB5A3;
                case TexFormat.RGBA32: return TextureFormats.RGBA32;
                default:
                    throw new Exception("Unknown Format " + Format);
            }
        }
        ...
        public static byte[] GetMipLevel(byte[] ImageData, uint Width, uint Height, uint MipCount, uint MipLevel, TexFormat format)
        {
        ...
        public static System.Drawing.Bitmap DecodeDataToBitmap(byte[] ImageData, byte[] PaletteData, uint width, uint height, TexFormat format, PaletteFormat palleteFormat)
        {
            var FormatGC = FromGenericFormat(format);
            var PalleteFormatGC = FromGenericPaletteFormat(palleteFormat);
            return BitmapExtension.CreateBitmap(DecodeData(ImageData, PaletteData, width, height, FormatGC, PalleteFormatGC),
               (int)width, (int)height, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
        }

        public static byte[] DecodeData(byte[] ImageData, byte[] PaletteData, uint width, uint height, TexFormat format, PaletteFormat palleteFormat)
        {
            var FormatGC = FromGenericFormat(format);
            var PalleteFormatGC = FromGenericPaletteFormat(palleteFormat);
